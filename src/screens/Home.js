...
export default function Home({ navigation, GlobalState}) {
  ...
  /*          let QUERY_KEY = await AsyncStorage.getItem('QUERY_KEY');
            ...
            locationAddress.street = Number(await AsyncStorage.getItem('street'));
            locationAddress.city = Number(await AsyncStorage.getItem('city'));
            locationAddress.state = Number(await AsyncStorage.getItem('state'));
            locationAddress.zip = Number(await AsyncStorage.getItem('zip'));
            locationAddress.country = Number(await AsyncStorage.getItem('country'));
    ...
    const updateInfo = async () => {
        ...
        return (TOTAL_DAI, TOTAL_CASH, rate);
    }
        ...
        <View style={styles.screen}>
            ...
            <View style={styles.body}>
                <View style={styles.container}>
                    ...
                    <TouchableOpacity
                        style={styles.button}
                        onPress={() => navigation.navigate('SetLocationAddress')}
                    >
                        <Text style={styles.buttonText} >Set Location Address</Text>
                    </TouchableOpacity>
                </View>
